...
public class UtilisateurDAO {
    ...
    static HashMap<String, Utilisateur> createMap()
    {
    	...
    	Utilisateur utilisateur1 = new Utilisateur(1, "moi","encore moi ", "0000",  "moa@gk.com", "blabla 59000", "symbioz");
		Utilisateur utilisateur2 = new Utilisateur(2, "lui","encore lui ", "0000",  "lui@gk.com", "blabla 59000", "LLLLUI");
