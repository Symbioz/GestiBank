...
public class AgentDAOImpl implements IAgentDAO{
    ...
    static HashMap<String, Agent> createMap()
    {
    	...
    	Agent agent3 = new Agent( 3,"NOM","prenom", "identifiant","mdp","couriel","adresse", "0564595515", 888, new Date());
    	Agent agent1 = new Agent( 1,"Vincent","jennifer", "login","222", "vincentjenni@gmail.com", "rue de lille 59200 lille", "0564595515",1337,new Date());
