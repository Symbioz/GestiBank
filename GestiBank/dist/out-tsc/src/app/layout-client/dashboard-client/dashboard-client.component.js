...
var DashboardClientComponent = /** @class */ (function () {
    function DashboardClientComponent(translate, router) {
        var _this = this;
    ...
    DashboardClientComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    DashboardClientComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
...
exports.DashboardClientComponent = DashboardClientComponent;
